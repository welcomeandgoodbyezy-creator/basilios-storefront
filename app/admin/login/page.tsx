...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#1a0f0a] text-amber-100 flex items-center justify-center px-6">
        ...
        <form onSubmit={handleSubmit} className="bg-gradient-to-br from-[#2c1810] to-[#1a0f0a] p-8 rounded-2xl border-2 border-amber-400/30 shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full bg-[#1a0f0a] border-2 border-amber-400/30 rounded-lg px-4 py-3 text-amber-100 focus:border-amber-400 focus:outline-none transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-[#2c1810] px-6 py-3 font-bold rounded-lg hover:from-amber-400 hover:to-amber-500 transition-all shadow-lg disabled:opacity-50"
          >
